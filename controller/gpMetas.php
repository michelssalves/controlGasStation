...
if ($action == 'findAll') {
    ...
    if ($gerencia) {$filtroGerencia = "AND gerenteRede = $gerencia";}

    if ($idGrupo == 1) { $campo = "qtde";$filtroGrupo = "AND id_grupo = 1"; $filtroProduto = "AND id_grupo = 1"; } //Combustiveis
    if ($idGrupo == 2) { $campo = "valor";$filtroGrupo = "AND id_grupo = 2";$filtroProduto = "AND id_grupo = 2";} //Lubrificantes
    if ($idGrupo == 6) { $campo = "qtde";$filtroGrupo = "AND id_grupo = 1"; $filtroProduto = "AND id_produto IN (1,2,3)";} //Ciclo OTTO
    if ($idGrupo == 7) { $campo = "qtde";$filtroGrupo = "AND id_grupo = 1"; $filtroProduto = "AND id_produto IN (4,5)";} //Diesel
