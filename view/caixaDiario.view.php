    ...
    <div class="container">
        <form method='POST' id='filtroCaixaDiario'>
            <div class="container text-center">
                ...
                <div class="row">
                    <div class="col"><input class='form-control' type='date' id='data1' name="data1" v-model="filtroData1"></div>
                    <div class="col"><input class='form-control' type='date' id='data2' name="data2" v-model="filtroData2"></div>
                    <div class="col">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu p-3">
                                <li><input type="checkbox" id="statusAberto" name="statusAberto" value="ABERTO" /> ABERTO</label></li>
                                <li><input type="checkbox" id="statusNovo" name="statusNovo" value="NOVO" /> NOVO</label></li>
                                <li><input type="checkbox" id="statusFechado" name="statusFechado" value="FECHADO" /> FECHADO</label></li>
                                <li><input type="checkbox" id="statusDefinitivo" name="statusDefinitivo" value="DEFINITIVO" /> DEFINITIVO</label></li>
                                <li><input type="checkbox" id="statusCancelado" name="statusCancelado" value="CANCELADO" /> CANCELADO</label></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col"> <select id="idMed" name="idMed" class='form-select' aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" required>
                    ...
                    <div class="modal-content">
                        <div class="modal-header fundo-cabecalho">
                            ...
                            <div class="d-flex flex-row">
                                ...
                                <div v-if="!(status == 'FECHADO')" class="p-1"><button type="button" @click="aplicarIcon ? salvarAlteracoes(id_requisicao, 'alterarCaixa') : '' " :title="aplicarIcon ? 'Editar Caixa' : 'Salvar'" class="btn btn-light btn-sm"><img class="iconeSize" @click="aplicarIcon = !aplicarIcon, readonly = !readonly, disabled = !disabled, title = !title" :src="aplicarIcon ? iconEdit : iconSave" /></button></div>
                                <div v-if="!(status == 'FECHADO')" class="p-1"><button :disabled="disabled" type="button" title="Observação" class="btn btn-light btn-sm" data-bs-dismiss="modal" @click="modalObservacao(id_requisicao)"><img class="iconeSize" :src="iconObs"></button></div>
                                <div v-if="!(status == 'FECHADO')" class="p-1"><button :disabled="disabled" type="button" title="Anexo" class="btn btn-light btn-sm" data-bs-dismiss="modal" @click="modalAnexar(id_requisicao)"><img class="iconeSize" :src="iconAnx"></button></div>
                                <div v-if="!(status == 'FECHADO')" class="p-1"><button :disabled="disabled" type="button" title="Cancelar Caixa" class="btn btn-light btn-sm" data-bs-dismiss="modal" @click="modalCancelar(id_requisicao)"><img class="iconeSize" :src="iconExc"></button></div>
                                <div class="p-1"><button type="submit" title="Fechar" :disabled="!disabled" id="botaoFechar" class="btn btn-sm"><img class="iconeSize" :src="iconClose"></button></div>
                            </div>
                        </div>
