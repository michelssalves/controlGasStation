...
<head>
    ...
    <title>Corrige Custo Ipiranga</title>
    ...
    <link rel="stylesheet" href="./assets/css/creditoIpirangaCorrige/creditoIpirangaCorrige.css">
    ...
    <script type="module" src="./assets/js/controllers/creditoIpirangaCorrigeCustoVue.js"></script>
</head>