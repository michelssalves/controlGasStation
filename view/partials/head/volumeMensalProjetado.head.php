...
<head>
    ...
    <link rel="stylesheet" href="./assets/css/volumeMensalProjetado/volumeMensalProjetado.css">
    ...
    <script type="module" src="./assets/js/controllers/volumeMensalProjetadoVue.js"></script>
</head>