...
<head>
    ...
    <link rel="stylesheet" href="./assets/css/analiseVendasClientes/analiseVendasClientes.css">
   ...
   <!-- <script src="./assets/js/axios.min.js"></script>
    ...
    <script type="module" src="./assets/js/controllers/analiseVendasClienteVue.js"></script>-->
</head>